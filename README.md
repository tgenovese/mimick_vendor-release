## mimick_vendor (jazzy) - 0.6.2-2

The packages in the `mimick_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --override-release-repository-push-url git@github.com:tgenovese/mimick_vendor-release.git mimick_vendor` on `Mon, 21 Jul 2025 20:08:58 -0000`
...
- release repository: https://github.com/tgenovese/mimick_vendor-release.git
...
## mimick_vendor (rolling) - 0.9.0-1

The packages in the `mimick_vendor` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release mimick_vendor -r rolling` on `Thu, 24 Apr 2025 19:46:16 -0000`
...
The packages in the `mimick_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy mimick_vendor` on `Fri, 06 Sep 2024 20:06:35 -0000`
...
## mimick_vendor (rolling) - 0.8.1-1

The packages in the `mimick_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling mimick_vendor` on `Mon, 29 Jul 2024 14:59:26 -0000`
...
## mimick_vendor (rolling) - 0.8.0-1

The packages in the `mimick_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling mimick_vendor` on `Mon, 17 Jun 2024 14:32:59 -0000`
...
## mimick_vendor (rolling) - 0.7.0-1

The packages in the `mimick_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release mimick_vendor --rosdistro rolling --non-interactive` on `Fri, 26 Apr 2024 16:29:56 -0000`
